...
public class BrevgenClientTests : TestBed<BrevgenBearerTokenFixture>
{
    private readonly IBrevgeneratorClient _sut;

    public BrevgenClientTests(ITestOutputHelper testOutputHelper, BrevgenBearerTokenFixture fixture)
        : base(testOutputHelper, fixture)
    {
        _sut = fixture.GetService<IBrevgeneratorClient>(testOutputHelper)!;
    }

    private static GenererBrevArgs SampleRequest = new Model.GenererBrevArgs()
    {
        Md = "# Test {test}",
