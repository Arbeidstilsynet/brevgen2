...
public class BrevgeneratorClientAdapterLayerTests
{
    static readonly Architecture Architecture = new ArchLoader()
        .LoadAssemblies(Layers.BrevgeneratorClientAssembly, Layers.SystemConsoleAssembly)
        .Build();

    [Fact]
    public void TypesInBrevgeneratorClient_HaveCorrectNamespace()
    {
        IArchRule archRule = Types()
            .That()
            .Are(Layers.BrevgeneratorClientLayer)
            .Should()
    ...
    [Fact]
    public void InterfaceImplementationsInBrevgeneratorClient_AreNotPublic()
    {
        IArchRule archRule = Types()
            .That()
    ...
    [Fact]
    public void TypesInBrevgeneratorClientAdapterLayer_DoNotDependOnAWS()
    {
        IArchRule archRule = Types()
            .That()
            .Are(Layers.BrevgeneratorClientLayer)
    ...
    [Fact]
    public void TypesInBrevgeneratorClientAdapterLayer_UseCorrectLogger()
    {
        IArchRule archRule = Types()
            .That()
            .Are(Layers.BrevgeneratorClientLayer)
            ...
            .Because("we want to use streamlined logging. Try using ILogger<T> via DependencyInjection to log.");
