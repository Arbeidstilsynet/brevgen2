...
- nuget-client
  - [BrevgeneratorKlient](nuget-client/BrevgeneratorKlient) - C#-klient for å bruke API - publisert som `Arbeidstilsynet.Brevgenerator.Klient`
  - [BrevgeneratorKlient.Tests](nuget-client/BrevgeneratorKlient.Tests) - Tester for `Arbeidstilsynet.Brevgenerator.Klient`
